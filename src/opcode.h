...
typedef enum opcode_enum {
    ...
    OPCODE_JUMP_IF_FALSE_OR_POP  = 90, // Followed by 4 bytes (aka jump offset)
    OPCODE_JUMP_IF_TRUE_OR_POP   = 91, // Followed by 4 bytes (aka jump offset)
    OPCODE_JUMP_FORWARD          = 92, // Followed by 4 bytes (aka jump offset)
    OPCODE_POPTOP                = 93, // No following bytes
    OPCODE_NOP                   = 94, // No following bytes
    OPCODE_RETURN                = 95  // No following bytes
} opcode_t;
