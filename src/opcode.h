...
typedef enum opcode_enum {
    ...
    OPCODE_JUMP_IF_CONTINUE                  = 127,  // Followed by 4 bytes (aka jump offset)
    OPCODE_JUMP_IF_BREAK                     = 128,  // Followed by 4 bytes (aka jump offset)
    OPCODE_ABSOLUTE_JUMP                     = 129,  // Followed by 4 bytes (aka jump offset)
    OPCODE_POPTOP                            = 130,  // No following bytes
    OPCODE_NOP                               = 131,  // No following bytes
    OPCODE_SETUP_CLASS                       = 132,  // No following bytes
    OPCODE_BEGIN_CLASS                       = 133,  // Followed by 8 bytes (aka code_t pointer/serialized address)
    OPCODE_EXTEND_CLASS                      = 134,  // No following bytes
    OPCODE_SETUP_FUNCTION                    = 135,  // No following bytes
    OPCODE_BEGIN_FUNCTION                    = 136,  // Followed by 8 bytes (aka code_t pointer/serialized address)
    OPCODE_SETUP_BLOCK                       = 137,  // No following bytes
    OPCODE_BEGIN_BLOCK                       = 138,  // Followed by 8 bytes (aka code_t pointer/serialized address)
    OPCODE_SETUP_CATCH_BLOCK                 = 139,  // Followed by 8 bytes (aka code_t pointer/serialized address)
    OPCODE_RETURN                            = 140,  // No following bytes
    OPCODE_RETURN_ASYNC                      = 141,  // No following bytes
    OPCODE_COMPLETE_BLOCK                    = 142,  // No following bytes
    OPCODE_DUPTOP                            = 143,  // No following bytes
    OPCODE_ROT2                              = 144,  // No following bytes
    OPCODE_ROT3                              = 145,  // No following bytes
    OPCODE_ROT4                              = 146,  // No following bytes
    OPCODE_SAVE_CAPTURES                     = 147,  // Followed by 4 bytes (aka the number of captures) + N bytes separated by null terminators
    OPCODE_GET_ITERATOR_OR_JUMP              = 148,  // Followed by 4 bytes (aka jump offset)
    OPCODE_HAS_NEXT                          = 149,  // Followed by 4 bytes (aka jump offset)
    OPCODE_GET_NEXT_VALUE                    = 150,  // No following bytes
    OPCODE_GET_NEXT_KEY_VALUE                = 151,  // No following bytes
    OPCODE_SET_PROPERTY                      = 152,  // Followed by the length of the property in bytes + 1 (for the null terminator)
    OPCODE_AWAIT                             = 153,  // No following bytes
    OPCODE_CONTINUE                          = 154,  // No following bytes
    OPCODE_BREAK                             = 155,  // No following bytes
    OPCODE_BEGIN_LOOP_THREAD                 = 156,  // No following bytes
    OPCODE_END_LOOP_THREAD                   = 157,  // No following bytes
